...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KOL AI Skill World — Sàn Skill bán hàng $2" },
      {
        name: "description",
        content:
          "Sàn giao dịch AI Skill giúp bạn tự tạo ảnh, video quảng cáo chuyên nghiệp — chỉ $2/skill.",
      },
      { name: "author", content: "KOL AI Skill World" },
